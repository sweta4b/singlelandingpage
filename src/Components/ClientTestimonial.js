 ...
 * Used for styling and data for Client's Testimonial Section
 */
  ...
  return (
    <div className='w-full bg-gray-100 my-40 hidden lg:block'>
        <div className='md:max-w-[1480px] max-w-[600px] flex flex-col items-center gap-8  m-auto  text-center py-20 px-2 md:px-0'>
            ...
            <h1 className=' text-5xl leading-tight text-blue-950  font-semibold  '>We've been with unicraft to kick start every new project and can't imagine working without it.</h1>
