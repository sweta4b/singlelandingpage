...
function Contact() {
  return (
    <div className='w-full bg-white mt-40 bg-gradient-to-b from-purple-50 via-white to-transparent '>
        <div className='md:max-w-[1480px] max-w-[600px]  m-auto  text-center py-20 px-2 md:px-0 border-b'>
            ...
            <button className=' my-4  bg-blue-950 text-white border-slate-400 px-8 py-3 rounded-md font-semibold text-gray-600 hidden md:block m-auto'>Contact Us</button>
        </div>
    </div>
  )
}
